...
const ThemeToggle = () => {
  ...
  return (
    <button onClick={() => setDark(!dark)} className="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors" title={dark ? 'Switch to Light Mode' : 'Switch to Dark Mode'}>
      {dark ? (
